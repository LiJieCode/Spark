...
object Demo03 {
    ...
    def main(args: Array[String]): Unit = {
        ...
        // 2.2 统计
        val mapClickRDD: RDD[(String, (Int, Int, Int))] = clickRDD.map(
            line => {
                val datas: Array[String] = line.split("_")
                (datas(6), (1, 0, 0))
            }
        )
        val clickWC: RDD[(String, (Int, Int, Int))] = mapClickRDD.reduceByKey(
            (t1, t2) => (t1._1 + t2._1, 0, 0)
        )
        ...
        // 3.2 统计
        val flatOrderRDD: RDD[(String, (Int, Int, Int))] = orderRDD.flatMap(
            line => {
                val datas: Array[String] = line.split("_")
        ...
        val orderWC: RDD[(String, (Int, Int, Int))] = flatOrderRDD.reduceByKey(
            (t1, t2) => (0, t1._2 + t2._2, 0)
        )
        ...
        // 4.2 统计
        val payWC: RDD[(String, (Int, Int, Int))] = payRDD.flatMap(
            line => {
                val datas: Array[String] = line.split("_")
        ...
        val rdd4: RDD[(String, (Int, Int, Int))] = clickWC.union(orderWC).union(payWC)
